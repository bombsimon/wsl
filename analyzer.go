...
func defaultConfig() *Configuration {
	return &Configuration{
		...
		AllowCuddleAssignmentNotUsedInBlock: false,
...
func (wa *wslAnalyzer) flags() flag.FlagSet {
	...
	flags.BoolVar(&wa.config.AllowCuddleAssignmentNotUsedInBlock, "allow-cuddle-assignment-not-used-in-block", false, "Allow cuddling assignment even if not used in block")
