...
const version = "wsl version v5.7.0"
...
func (wa *wslAnalyzer) flags() flag.FlagSet {
	...
	flags.IntVar(&wa.config.CuddleMaxStatements, "cuddle-max-statements", 1, "Max number of cuddled statements above block statements")
