...
* [Only One Cuddle Assignment Allowed Before Type Switch Statement](https://github.com/hollowaykeanho/wsl/blob/master/doc/rules.md#only-one-cuddle-assignment-allowed-before-type-switch-statement)
